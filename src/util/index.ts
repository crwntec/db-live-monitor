...
export function getHintIcon(code: string | null | undefined, text: string) {
  ...
  if (
    codeStr.includes("wifi") ||
    textStr.includes("wlan") ||
    textStr.includes("wifi")
  ) {
    return Wifi;
  }
  if (
    codeStr.includes("br") ||
    codeStr.includes("restaurant") ||
    textStr.includes("restaurant") ||
    textStr.includes("bordrestaurant")
  ) {
  ...
  if (
    codeStr.includes("fk") ||
    codeStr.includes("bicycle") ||
    textStr.includes("fahrrad")
  ) {
    return Bike;
  }
