        ...
        for (const item of items) {
            ...
            if (isArrival) {
                if (existing) {
                    ...
                    const isScheduledToContinue = scheduledDestination != undefined && (scheduledDestination !== currentStation);
                    const doesNotContinue = irisItem != undefined && (!irisItem?.departurePath || irisItem?.departurePath.length === 0);
                    ...
                    processedItems.set(key, {
                        ...
                        departure: null,
                        isEarlyTerminated:
                            isScheduledToContinue && doesNotContinue,
